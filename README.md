...
* 🌟 [arXiv 2024.07](https://arxiv.org/abs/2407.01512), Open-TeleVision: Teleoperation with Immersive Active Visual Feedback, [website](https://robot-tv.github.io/) / [code](https://github.com/OpenTeleVision/TeleVision) ⭐ 1,312 | 🐛 41 | 🌐 Python | 📅 2024-09-27
...
* 🌟 [arXiv 2024.03](https://arxiv.org/abs/2403.07788), DexCap: Scalable and Portable Mocap Data Collection System for Dexterous Manipulation, [website](https://dex-cap.github.io/) / [code](https://github.com/j96w/DexCap) ⭐ 418 | 🐛 11 | 🌐 Python | 📅 2024-10-10
...
* [github](https://github.com/UZ-SLAMLab/ORB_SLAM3) ⭐ 9,096 | 🐛 572 | 🌐 C++ | 📅 2024-07-24, ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM
* [github](https://github.com/HKUST-Aerial-Robotics/VINS-Fusion) ⭐ 4,725 | 🐛 212 | 🌐 C++ | 📅 2024-05-23, VINS-Fusion: An optimization-based multi-sensor state estimator
...
* [github](https://github.com/MuShibo/Micro-Wheeled_leg-Robot) ⭐ 3,606 | 🐛 11 | 🌐 C++ | 📅 2024-12-12, Micro-Wheeled\_leg-Robot
* [github](https://github.com/TetherIA/aero-hand-open/tree/main) ⭐ 964 | 🐛 1 | 🌐 Python | 📅 2026-09-15, Aero Hand Open
...
* arXiv 2024.12, **Genesis**: A Generative and Universal Physics Engine for Robotics and Beyond, [code](https://github.com/Genesis-Embodied-AI/Genesis) ⭐ 29,970 | 🐛 127 | 🌐 Python | 📅 2026-09-21 / [website](https://genesis-embodied-ai.github.io/)
* 🌟 [arXiv 2024.10](https://arxiv.org/abs/2410.00425), ManiSkill3: GPU Parallelized Robotics Simulation and Rendering for Generalizable Embodied AI, [website](https://www.maniskill.ai/home) / [code](https://github.com/haosulab/ManiSkill) ⭐ 3,350 | 🐛 135 | 🌐 Python | 📅 2026-08-04
* 🌟 2025.01, MuJoCo Playground, [github](https://github.com/google-deepmind/mujoco_playground) ⭐ 2,225 | 🐛 112 | 🌐 Python | 📅 2026-09-19 / [website](https://playground.mujoco.org/)
* 🌟 [arXiv 2024.04](https://arxiv.org/abs/2404.05695), Humanoid-Gym: Reinforcement Learning for Humanoid Robot with Zero-Shot Sim2Real Transfer, [website](https://sites.google.com/view/humanoid-gym/) / [code](https://github.com/roboterax/humanoid-gym) ⭐ 2,092 | 🐛 24 | 🌐 Python | 📅 2025-01-26
* 🌟 [arXiv 2024.06](https://arxiv.org/abs/2406.02523), RoboCasa: Large-Scale Simulation of Everyday Tasks for Generalist Robots, [website](https://robocasa.ai/) / [code](https://github.com/robocasa/robocasa) ⭐ 1,747 | 🐛 58 | 🌐 Python | 📅 2026-09-02
* 🌟 [arXiv](https://arxiv.org/abs/2407.10943), GRUtopia: Dream General Robots in a City at Scale, [website](https://github.com/OpenRobotLab/GRUtopia) ⭐ 1,292 | 🐛 29 | 🌐 Python | 📅 2025-09-04
